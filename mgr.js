define(['managerAPI',
	...
	init_data_pipe(API, 'Oo9HYv7wULf8',  {file_type:'csv'});	
    ...
    API.addTasksSet({
        ...
        gender_ministry_instructions: [{
            inherit: 'instructions',
            name: 'gender_ministry_instructions',
            templateUrl: 'gender_ministry_instructions.jst',
